...
#################################################
    ...
    """
    quickSort_partition: Partitions array by selecting a pivort, elementts less than or equal to the pviot are moved left 
                    of the pivot, and elements greater than the pivot are moved to the right 
    """
